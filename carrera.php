...
document.addEventListener('click', handleClickOutside);
    ...
    <div style="display: inline;text-decoration: none">
      <a href="/">
        ...
        <span class="textoIzq" style="text-decoration: none; border: none; text-stroke: none">Inicio</span>
        </div>
      </a>
      <a href="/Categorias/">
        <div class="izqCat">
        <span class="textoIzq" style="text-decoration: none; border: none; text-stroke: none">Categorías</span>
        </div>
      </a>   
      <a href="/Carreras/">
        <div class="izqCat">
        <span class="textoIzq" style="text-decoration: none; border: none; text-stroke: none">Carreras</span>
        </div>
      </a>
      <a href="/Materias/">
        <div class="izqCat">
        <span class="textoIzq" style="text-decoration: none; border: none; text-stroke: none">Materias</span>
        </div>
      </a>
      <a href="/usuarios/">
        <div class="izqCat">
        <span class="textoIzq" style="text-decoration: none; border: none; text-stroke: none">Usuarios</span>
        </div>
      </a>   
      <a href="/Publicaciones/">
        <div class="izqCat">
        <span class="textoIzq"</span>
        </div>
      </a>
    </div>
