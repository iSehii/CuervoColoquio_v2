...
<iframe src="https://analytics.google.com/analytics/web/#/p382591331/realtime/overview?params=_u..nav%3Dmaui" frameborder="0"></iframe>
          </div>
          <div class="categorias"
            style="flex-wrap: wrap; justify-content: space-between; align-items: center; align-items: center; align-content: center; vertical-align: middle;">
            <a href="calculo"
              style="width: 30%; height: 100px; align-items: center; align-content: center; vertical-align: middle;">
              <div class="PanelBotones" style=""><br>
                Cálculo diferencial
              </div>
            </a>
            <?php
            ...
            for ($i = 0; $i < $Dashboard->getTotal(); $i++) {
              ?>
              <a href="tablas.php?tabla_index=<?php echo $i; ?>"
                style="width: 30%; height: 100px; align-items: center; align-content: center; vertical-align: middle;">
                <div class="PanelBotones"> <br id="BR">
                  <?php echo $Dashboard->getNombre($i); ?>
                </div>
