  ...
  gtag('config', 'G-XW9F8F1MVS');
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1161956724578947"
     ...
     <div class="encabezado">
        ...
        <div class="inicio">
            <a href="/" target="_self"> <img class="logoDesktop" src="../files/behuse-logos/behuse-logotipo.png"></a>
            <a href="/" target="_self"> <img class="logo" src="../files/behuse-logos/behuse-logo.png"></a>
        </div>
