...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-S1KL8WE21Y"></script>
    ...
    <link rel="stylesheet" href="/style/Logged.css">
...
document.addEventListener('click', handleClickOutside);
    ...
    <div class="Contenido">
                <div class="centro">
                    ...
                    <h3>Da clic en la carrera que desees.</h3>
                    <div class="categorias">
                        ...
                        <div class="carr IGDSM">
                          <a href="IGDSM/">
                            <button>Ingenieria en Desarrollo de Software Multiplataforma</button>
                          </a>
                        </div>
                        <div class="carr IRD">
                          <a href="IRD/">
                        ...
                        <div class="carr IGIRD">
                          <a href="IGIRD/">
                            <button>Ingenieria de Infraestructura de Redes Digitales</button>
                          </a>
                        </div>
                    </div> 
                    </div>
